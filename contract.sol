...
contract FLORIDA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xCcff2853D67C92b6511217b9224558046818D677); 
    address payable public Wallet_Dev = payable(0xC6aa2f0FF6b8563EA418ec2558890D6027413699);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal =100000000000 * 10**_decimals;
    string private constant _name = "Florida Citizens"; 
    string private constant _symbol = unicode"FLORIDA"; 
